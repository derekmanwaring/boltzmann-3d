...
package edu.byu.chem.boltzmann.modules.idealgasrms;
...
import edu.byu.chem.boltzmann.modules.idealgasrms.view.IdealGasRMSView;
...
public class IdealGasRMSApplet {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                final IdealGasRMSView idealGasView = new IdealGasRMSView();
                final Controller rootController = new IdealGasRMSController(idealGasView);
