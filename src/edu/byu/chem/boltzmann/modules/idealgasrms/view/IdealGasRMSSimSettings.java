 ...
 * 15 May 2012
 */
public class IdealGasRMSSimSettings extends JPanel implements SimSettingsView {
    ...
    public IdealGasRMSSimSettings() {  
        ...
        selectedStats.setSelected(setForSingleParticleDesc, RMSVelocity.class, true);
