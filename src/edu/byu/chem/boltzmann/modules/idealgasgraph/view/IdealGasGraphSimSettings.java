 ...
 * 9 May 2012
 */
public class IdealGasGraphSimSettings extends JPanel implements SimSettingsView {
    ...
    private static final int ALIGNED_ROW_WIDTH = 255; // pixels
    ...
    public IdealGasGraphSimSettings() {  
        initComponents();
        ...
        selectedStats.setSelected(setForSingleParticleDesc, InstantaneousSpeed.class, true);
    ...
    private void initComponents() {
        ...
        pnlSettingsHeader.setLayout(flowLayout1);
    ...
    private void btnApplySettingsActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        applySettings();
    }                                                
