 ...
 * June 1, 2012
 */
public class XVelocity implements StatisticWithDistribution<Velocity> {
    ...
    public XVelocity(SimulationInfo simInfo, Set<ParticleType> types) {
