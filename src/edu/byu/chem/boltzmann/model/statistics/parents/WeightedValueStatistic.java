 ...
 */
public abstract class WeightedValueStatistic extends SingleAverageStatisticOld {
    ...
    public void initiateStatistic(Set<ParticleType> types, SimulationInfo simInfo) {
        super.initiateStatistic(types, simInfo);
    ...
    public void addInstWeightedValue(double value, double weight, Color color) {
        instTotalWeightedValues += value * weight;
    ...
    public double getInstAverage() {
        return instTotalWeightedValues / instTotalWeight;
    }
