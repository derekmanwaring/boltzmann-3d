 ...
 * June 1, 2012
 */
public class YVelocity implements StatisticWithDistribution<Velocity> {
    ...
    public YVelocity(SimulationInfo simInfo, Set<ParticleType> types) {
