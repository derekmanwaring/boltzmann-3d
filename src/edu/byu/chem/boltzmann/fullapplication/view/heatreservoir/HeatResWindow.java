 ...
 */
public class HeatResWindow extends javax.swing.JFrame {

    private final HeatResFullView view;
    
    /** Creates new form Window */
    public HeatResWindow() {
        super("Heat Reservoir");
        
        attachEscapeListener();
        
        view = new HeatResFullView();
    ...
    private void attachEscapeListener() {
        ...
        Action hide = new AbstractAction() {
            public void actionPerformed(ActionEvent e) {
                view.getController().hideReservoirControls();
            }
        };
