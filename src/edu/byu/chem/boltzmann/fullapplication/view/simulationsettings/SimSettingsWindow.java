...
/**
 * Window for the simulation settings view.
 * @author Derek Manwaring
 */
public class SimSettingsWindow extends javax.swing.JFrame {

    private final SimSettingsFullView view = new SimSettingsFullView();

    /**
     * A new window for the simulation settings. This window creates its own view.
     */
    public SimSettingsWindow() {
    ...
    public SimSettingsView getView() {
        return view;
    }
